    ...
    <div class="main-content">
        <div class="igny8-section">
            <div class="igny8-section-header">
                ...
                <p>Organize and manage keyword clusters for better content strategy and SEO performance.</p>
            </div>
            
            <div class="igny8-section-body">
                <!-- 1️⃣ Filters Panel (Sticky Top, 2 Columns) -->
                ...
                <!-- 2️⃣ Metrics Summary (Inline Cards) -->
                ...
                <!-- 3️⃣ Action Buttons (Right-Aligned) -->
