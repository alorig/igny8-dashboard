<?php
/**
 * Template Name: Account Settings Module
 * Template Post Type: page
 * 
 * Account Settings Module Page
 * Loads the same Account Settings content as wp-admin but on frontend
 */
get_header();
get_sidebar();
?>
<div class="main-content">
    <h1>Account Settings Module Dashboard</h1>
    <div class="module-content">
        <p>Welcome to the Account Settings module. This section manages your user profile, password, and personal preferences.</p>
