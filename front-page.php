    ...
    <div class="dashboard-modules">
        ...
        <div class="module-grid">
            <div class="module-card">
                ...
                <a href="<?php echo home_url('/intelli/'); ?>" class="module-link">Access INTELLI</a>
            </div>
            
            <div class="module-card">
                <h3>LOOPS</h3>
                <p>Automation and workflow management</p>
                <a href="<?php echo home_url('/loops/'); ?>" class="module-link">Access LOOPS</a>
            </div>
            
            <div class="module-card">
                <h3>HIVE</h3>
                <p>Collaborative workspace and communication</p>
                <a href="<?php echo home_url('/hive/'); ?>" class="module-link">Access HIVE</a>
            </div>
            
            <div class="module-card">
                <h3>Clusters</h3>
                <p>Data clustering and organization</p>
                <a href="<?php echo home_url('/clusters/'); ?>" class="module-link">Access Clusters</a>
            </div>
            
            <div class="module-card">
                <h3>Keywords</h3>
                <p>Keyword management and optimization</p>
                <a href="<?php echo home_url('/keywords/'); ?>" class="module-link">Access Keywords</a>
            </div>
        </div>
    </div>
</div>
